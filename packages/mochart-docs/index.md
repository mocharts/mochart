...
features:
  ...
  - title: No framework required
    details: Charts are drawn with a retained-mode SVG renderer, with no vdom and no framework runtime. First-class bindings wrap the same core for Angular, Lit, React, Svelte, and Vue.
    link: /guide/getting-started
