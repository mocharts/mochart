...
// bars would all grow up from the most negative value. Setting base: 0
// makes them grow out of zero instead. The outside labels flip on their
// own: above positive bars, below negative ones.
