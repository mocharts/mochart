import { Renderer, svgEl, htmlEl, El } from '../render/index.js';
import type { ElSlot, RendererItem, RendererList, Slot } from '../render/index.js';
...
import { isDataProviderValid, getCategorySeriesValueObject, getChartDataCategoryCount } from '../data/ChartData.js';
...
import { getChartLayoutInfo, getChartLayoutInfoWithMutations } from '../layout/ChartLayout.js';
import { getTooltipLayoutInfo, getTooltipLayoutInfoWithMutations } from '../layout/TooltipLayout.js';
import { getAxisData, getAxisDataWithMutations, getAxisDataForCategoryChange, getAxisDataForSeriesChange } from '../data/AxisData.js';
import { getStackData, getStackDataWithMutations } from '../data/StackData.js';
import { getChartTextBoundsData, getChartTextBoundsDataWithMutations, getTooltipBounds, getBoundsWithMutations } from '../utils/TextMeasurement.js';
import { mochartCssClasses, mochartVersionAttribute, getDomAccessors } from '../utils/ChartDom.js';
import { CHART_TYPE_PIE, NONE } from '../config/core/constants.js';
...
import PlotEmpty from './PlotEmpty.js';
import Legend from './Legend.js';
import LegendClip from './LegendClip.js';
import Tooltip from './Tooltip.js';
import TooltipClip from './TooltipClip.js';
import TitleClip from './TitleClip.js';
import AxisTitleClip from './AxisTitleClip.js';
import CategoryAxisTickLabelClip from './CategoryAxisTickLabelClip.js';
import SeriesClip from './SeriesClip.js';
import { getClippedEdgesWithMutations, noClippedEdges } from '../data/ClipData.js';
import SeriesColorGradient from './SeriesColorGradient.js';
import LinearGradient from './LinearGradient.js';
import RadialGradient from './RadialGradient.js';
import Pattern from './Pattern.js';
import { accessibilityActive, activeElementIn, focusRestored, translateObject } from '../utils/utils.js';
import { getSeriesFillColor, getSeriesSwatchGradient } from '../utils/SeriesColors.js';
import { getTooltipAnnouncement } from '../utils/TooltipFormat.js';
import type { ChartFactoryContent, ChartFactoryContext, ChartContentFactory, ChartEventPayload, ChartSeriesClickPayload, ChartSliceClickPayload, InternalFocus } from '../types/chart.js';
import type { AxisThresholdStepConfig, LinearGradientConfig, PatternConfig, RadialGradientConfig, ThresholdConfig } from '../types/config.js';
import { resolveThresholds } from '../config/defaults/axisConfig.js';
import { getThresholdPatternKey } from './AxisThreshold.js';
import { CATEGORY_AXIS_THRESHOLD_KEY, getValueAxisThresholdKey } from './AxisThresholdContainer.js';
import type { EnhancedMochartConfig, EnhancedSeriesConfig, EnhancedValueAxisConfig } from '../types/enhanced.js';
import type { AxisData, ChartData, ClippedEdges, DataProvider, StackData } from '../types/data.js';
import type { FocusData } from '../types/animation.js';
import type { ChartLayoutInfo, ChartTextBoundsData, LayoutInfo } from '../types/layout.js';
