import { Renderer, svgEl, ElList } from '../render/index.js';

import { getSeriesPositionData } from '../utils/SeriesPositions.js';
import { getLineGenerator, getRangeLineGenerator, getAreaGenerator, getColumnGenerator } from '../utils/SeriesShapes.js';
import { getSeriesColorGenerator, usesCategoryIndexColor } from '../utils/SeriesColors.js';
import { getSeriesFocusPercentage } from '../utils/SeriesFocus.js';
import { getSeriesTitle } from '../utils/SeriesTitle.js';
import { seriesIsInteractive } from '../utils/RovingFocus.js';
import { mochartCssClasses } from '../utils/ChartDom.js';
import { areArraysAndEqual, translateObject, isHoverPointer } from '../utils/utils.js';
import { NONE, RENDERER_AREA, RENDERER_LINE, RENDERER_BAR } from '../config/core/constants.js';
import { getSeriesFillColor, getSeriesStrokeColor } from '../utils/SeriesColors.js';
...
import SeriesErrorBars from './SeriesErrorBars.js';
import SeriesMarkers from './SeriesMarkers.js';
import SeriesLabels from './SeriesLabels.js';
import type { El, ElListAdapter } from '../render/index.js';
import type { ColorPaletteConfig, CategoryAxisConfig, FontConfig } from '../types/config.js';
import type { EnhancedSeriesConfig } from '../types/enhanced.js';
import type { FocusData } from '../types/animation.js';
import type { AxisScale, CategoryAxisData, NullableDomain, SeriesDomainObject, SeriesPositionData, SeriesValueObject, StackData } from '../types/data.js';
