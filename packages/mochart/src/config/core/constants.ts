...
export const STEP_PERIOD_SECOND = 'second';
export const STEP_PERIOD_MINUTE = 'minute';
export const STEP_PERIOD_HOUR = 'hour';
...
export const STEP_PERIODS = [STEP_PERIOD_SECOND, STEP_PERIOD_MINUTE, STEP_PERIOD_HOUR, STEP_PERIOD_DAY, STEP_PERIOD_WEEK, STEP_PERIOD_MONTH, STEP_PERIOD_YEAR];

export const CATEGORY_VALUE_INTERVAL_PERIOD_SECOND = 'second';
export const CATEGORY_VALUE_INTERVAL_PERIOD_MINUTE = 'minute';
export const CATEGORY_VALUE_INTERVAL_PERIOD_HOUR = 'hour';
export const CATEGORY_VALUE_INTERVAL_PERIOD_DAY = 'day';
export const CATEGORY_VALUE_INTERVAL_PERIOD_WEEK = 'week';

export const CATEGORY_VALUE_INTERVAL_PERIODS = [
...
export type StepPeriod =
  typeof STEP_PERIOD_SECOND | typeof STEP_PERIOD_MINUTE | typeof STEP_PERIOD_HOUR |
  typeof STEP_PERIOD_DAY | typeof STEP_PERIOD_WEEK | typeof STEP_PERIOD_MONTH | typeof STEP_PERIOD_YEAR;
export type CategoryValueIntervalPeriod =
  typeof CATEGORY_VALUE_INTERVAL_PERIOD_SECOND | typeof CATEGORY_VALUE_INTERVAL_PERIOD_MINUTE | typeof CATEGORY_VALUE_INTERVAL_PERIOD_HOUR |
  typeof CATEGORY_VALUE_INTERVAL_PERIOD_DAY | typeof CATEGORY_VALUE_INTERVAL_PERIOD_WEEK;
