export default function getDescriptions() {
  return {
    ...
    foregroundColor: 'the color of the pattern marks: use "owner" for the normal fill color of the series or threshold range the pattern fills, or "currentColor" to follow the host page CSS color',
    foregroundOpacity: 'the opacity (0 - 1) of the pattern marks',
    backgroundColor: 'the color behind the pattern marks: use "owner" for the normal fill color of the series or threshold range the pattern fills, "currentColor" to follow the host page CSS color, or null for a transparent background',
