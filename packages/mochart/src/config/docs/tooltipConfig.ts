...
export default function getDescriptions() {
  return {
    ...
    followPointer: 'whether the tooltip should track the mouse position in the chart drawing area; a following tooltip ignores the pointer, so its rows and controls cannot be used and the on-click and on-hover settings and showControls must stay false',
    closeOnClick: 'whether to hide the tooltip when the user clicks/taps within it',
    filterSeriesOnClick: 'whether series should be filtered when the user clicks/taps on them in the tooltip (must be false when followPointer is true)',
    focusCategoryOnClick: 'whether a click/tap on the category row of the tooltip should pin the focus on that category, so it stays focused after the tooltip closes (a second click releases it; must be false when followPointer is true)',
    focusSeriesOnClick: 'whether a click/tap on a series row of the tooltip should pin the focus on that series, so it stays focused after the pointer leaves (a second click releases it; must be false when followPointer is true)',
    focusCategoryOnHover: 'whether category values should be focused when the user hovers the pointer over them in the tooltip (must be false when followPointer is true)',
    focusSeriesOnHover: 'whether series should be focused when the user hovers the pointer over them in the tooltip (must be false when followPointer is true)',
    showCategory: 'whether the category value should be shown as the first line of the tooltip',
    showControls: 'whether the focus/filter controls should be shown at the top of the tooltip (must be false when followPointer is true)',
