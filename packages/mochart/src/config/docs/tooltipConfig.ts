...
export default function getDescriptions() {
  return {
    ...
    focusCategoryOnClick: 'whether category values should be focused when the user clicks/taps on them in the tooltip (must be false when followPointer is true)',
    focusSeriesOnClick: 'whether series should be focused when the user clicks/taps on them in the tooltip (must be false when followPointer is true)',
