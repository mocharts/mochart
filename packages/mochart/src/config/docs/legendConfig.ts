...
export default function getDescriptions() {
  return {
    ...
    truncationText: 'the truncation text to append to legend item text when its width exceeds the width of the chart',
    truncationTooltipEnabled: 'whether a truncated legend item shows its full series title as the browser’s native tooltip while a pointer rests on it',
