  ...
  return {
    ...
    tickStep: {
      ...
      properties: {
        ...
        minorPeriod: 'Needs a `period`, and must be a shorter period than it: a week inside a month, or a day inside a week. A minor tick on a period boundary is dropped, and one closer to a period boundary than a whole minor period, such as a Monday the day after the 1st of a month, is hidden with its tick mark and grid line.',
