...
import accessibilityValidators from './accessibilityConfig.js';
import animationValidators from './animationConfig.js';
import chartValidators from './chartConfig.js';
import colorPaletteValidators from './colorPaletteConfig.js';
import clipIndicatorValidators from './clipIndicatorConfig.js';
import crosshairValidators from './crosshairConfig.js';
import categoryAxisValidators from './categoryAxisConfig.js';
import { validateAxisBounds, validateThresholdEntries, validateStepRules, validateTickEntries } from './axisConfig.js';
import legendValidators from './legendConfig.js';
import linearGradientValidators from './linearGradientConfig.js';
import patternValidators from './patternConfig.js';
import pieValidators from './pieConfig.js';
import plotValidators from './plotConfig.js';
import radialGradientValidators from './radialGradientConfig.js';
import valueAxisValidators from './valueAxisConfig.js';
import seriesValidators from './seriesConfig.js';
import seriesGroupValidators from './seriesGroupConfig.js';
import seriesStackValidators from './seriesStackConfig.js';
import titleValidators from './titleConfig.js';
import tooltipValidators from './tooltipConfig.js';
import type { Validator } from '@mochart/movalid';
import type { ConfigDiagnostic, ConfigValidation, DetailedConfigValidation } from '../../types/config.js';
...
function validateConfigInternal(configWithoutDefaults: unknown, configDefaults: ConfigRecord, strict = true): InternalConfigValidation {
  ...
  if (objectValidator(configWithoutDefaults) && isConfigRecord(configWithoutDefaults)) {
    ...
    validateTickEntries(config, configWithoutDefaults, errors, errorDetails);
  }
  else {
