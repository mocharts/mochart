...
// The showcase's smoke suite, separate from the galleries' (own port); Chromium only, because clipboard reads need it and demo-basic already runs the engine matrix.
